...
{
    public class CustomHttpHandler(IUserAccountService accountService,GetHttpClient getHttpClient,LocalStorageService localStorageService):DelegatingHandler
    {
